module.exports = {
  ...
  onShow: function(e) {
    ...
    if (this.currentPage = e, t.onShowData && t.onShowData.scene) {
      ...
      0 <= o.indexOf(t.onShowData.scene) ? this.setPageNavbar() : (console.log("no in array--\x3e", t.onShowData.scene), console.log("the array--\x3e", o))
    }
  ...
  setPageNavbar: function() {
    ...
    function n(e) {
      ...
      for (var o in e.navs) {
        ...
        for (var i in n = e.navs[o].new_url, s.options) getApp().helper.inArray(i, ["scene", "user_id", "uid"]) || "page_id" == i && -1 == s.options[i] || (-1 == a.indexOf("?") ? a += "?" : a += "&", a += i + "=" + s.options[i]);
