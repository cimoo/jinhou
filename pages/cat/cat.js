...
Page({
  ...
  loadData: function(t) {
    var a = this,
      e = getApp().core.getStorageSync(getApp().const.STORE);
      ...
      success: function(t) {
        if (0 == t.code) {
          ...
          for (var e in t.data.list)
            for (var o in t.data.list[e].id == i && (a = !1, s.data.current_cat = t.data.list[e], 0 < t.data.list[e].list.length ? (s.setData({
                catheight: 100
              }), s.firstcat({
                currentTarget: {
                  dataset: {
              ...
              }, !1)), t.data.list[e].list) t.data.list[e].list[o].id == i && (a = !1, s.data.current_cat = t.data.list[e], s.goodsItem({
              currentTarget: {
                dataset: {
                  index: o
                }
  ...
  list: function(a, t) {
    ...
    getApp().request({
      ...
      success: function(t) {
        0 == t.code && (getApp().core.hideLoading(), 0 == t.data.list.length && (is_no_more = !0), e.setData({
          page: o + 1
        }), e.setData({
